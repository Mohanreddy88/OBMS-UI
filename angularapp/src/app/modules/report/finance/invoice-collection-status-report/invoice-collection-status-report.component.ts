...
@Component({
  selector: 'app-invoice-collection-status-report',
  templateUrl: './invoice-collection-status-report.component.html',
  styleUrls: ['./invoice-collection-status-report.component.css']
})
export class InvoiceCollectionStatusReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getUserAccessRights(this.currentUser, 'Invoice Collection Status Report');
  }
