...
@Component({
  selector: 'app-branch-collections',
  templateUrl: './branch-collections.component.html',
  styleUrls: ['./branch-collections.component.css']
})
export class BranchCollectionsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getUserAccessRights(this.currentUser, 'Branch Collections Report');
  }
  ...
  clkBtn(number: number) {    
    this.reportPageName = number == 1 ? "BranchCollectionReport.aspx?" : 'InvoiceCollectionTotalReportNoTax.aspx?';
